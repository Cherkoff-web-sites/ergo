// Скрипт для исправления кодировки и создания правильных данных
...
// Генерируем данные
const data = generateRandomProducts();

// Сохраняем с правильной кодировкой UTF-8
fs.writeFileSync('random-data-fixed.json', JSON.stringify(data, null, 2), 'utf8');
console.log('Данные сохранены в random-data-fixed.json');
